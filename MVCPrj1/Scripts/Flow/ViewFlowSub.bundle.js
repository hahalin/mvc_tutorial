...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewFlowFormData = __webpack_require__(1);

	var _ViewFlowFormData2 = _interopRequireDefault(_ViewFlowFormData);

	//var FormData =require('ViewForm/FormData');

	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(159);var Tabs = React.createClass({
		displayName: 'Tabs',
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'ul',
					{ className: 'nav nav-tabs', role: 'tablist', id: 'mtabs' },
					React.createElement(
						'li',
						{ role: 'presentation', className: 'active' },
						React.createElement(
							'a',
							{ href: '#fma-tab1', 'aria-controls': 'tab', role: 'tab', 'data-toggle': 'tab' },
							'本文'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab2', 'aria-controls': 'tab2', role: 'tab', 'data-toggle': 'tab' },
							'審核'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab3', 'aria-controls': 'tab3', role: 'tab', 'data-toggle': 'tab' },
							'夾檔'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab4', 'aria-controls': 'tab4', role: 'tab', 'data-toggle': 'tab' },
							'流程'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab5', 'aria-controls': 'tab5', role: 'tab', 'data-toggle': 'tab' },
							'副本'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab6', 'aria-controls': 'tab6', role: 'tab', 'data-toggle': 'tab' },
							'加簽'
						)
					),
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: '#fma-tab7', 'aria-controls': 'tab7', role: 'tab', 'data-toggle': 'tab' },
							'檢視'
						)
					)
				),
				React.createElement(
					...
					React.createElement(
						'div',
						{ role: 'tabpanel', className: 'tab-pane active fade in', id: 'fma-tab1' },
						React.createElement(
							'p',
							null,
							React.createElement(_ViewFlowFormData2['default'], { co_code: '1', uid: 'T000165' })
						)
					),
					React.createElement(
						'div',
						{ role: 'tabpanel', className: 'tab-pane fade in', id: 'fma-tab2' },
						React.createElement(
							'p',
							null,
							React.createElement(
								'form',
								{ id: 'fmSign', className: 'form-horizontal' },
								React.createElement(
									'div',
									{ className: 'row' },
									React.createElement(
										'div',
										{ className: 'col-md-10' },
										React.createElement('input', { type: 'button', className: 'btn btn-primary', value: '同意' }),
										React.createElement('input', { type: 'button', className: 'btn btn-warning', value: '不同意' })
									)
								),
								React.createElement(
									'div',
									...
									React.createElement(
										...
										React.createElement('textarea', { id: 'txtOpinion', rows: '15', className: 'form-control' })
									),
									React.createElement(
										'div',
										{ className: 'col-md-8' },
										...
										React.createElement(
											'table',
											{ id: 'tbSignHistory', className: 'display table table-striped table-bordered table-hover' },
											React.createElement(
												'thead',
												null,
												React.createElement(
	...
	ReactDOM.render(React.createElement(Tabs, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormData = (function (_React$Component) {
		...
		function FormData(props) {
			...
			_get(Object.getPrototypeOf(FormData.prototype), "constructor", this).call(this, props);
		}

		_createClass(FormData, [{
			key: "render",
			value: function render() {
				var co_code = this.props.co_code;
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("input", { defaultValue: this.props.uid })
				);
			}
		}]);
